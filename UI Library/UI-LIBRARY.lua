if (game:GetService("CoreGui")):FindFirstChild("RezexisHub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).RezexisHub:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(100, 100, 100);
_G.Dark = Color3.fromRGB(22, 22, 26);
_G.Third = Color3.fromRGB(0, 0, 255);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Rezexis Hub") then
			makefolder("Rezexis Hub");
		end;
		if not isfolder("Rezexis Hub/Library/") then
			makefolder("Rezexis Hub/Library/");
		end;
		if not isfile(("Rezexis Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Rezexis Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Rezexis Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Rezexis Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Rezexis Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local RezexisHub = Instance.new("ScreenGui");
	RezexisHub.Name = "RezexisHub";
	RezexisHub.Parent = game.CoreGui;
	RezexisHub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = RezexisHub;
	...
	CreateButton("Reset Config", function()
		if isfolder("Rezexis Hub") then
			delfolder("Rezexis Hub");
		end;
